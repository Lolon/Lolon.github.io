...
function setup() {
  ...
  BeachDiorama = new Diorama(1);
    BeachDiorama.isTicking = false;
    BeachDiorama.isDrawing = false;
  }
...
function draw() {             //every tick
  ...
  if (BeachDiorama.isTicking == true){
      BeachDiorama.DioTick();
      }

}

function mouseClicked(){
  BeachDiorama.isTicking = true;                          //logic for randomising events
  console.log("click");
